...
export const tagList: SxProps<Theme> = {
  display: 'flex',
  flexWrap: 'wrap',
  gap: 0.375,
};
...
// TableOfContents
export const tocList: SxProps<Theme> = {
  display: 'flex',
  flexDirection: 'column',
  gap: 0.25,
};
...
export const infoPanelInlineContent: SxProps<Theme> = {
  flex: 1,
  px: 2,
  py: 1.5,
  overflow: 'auto',
...
export const sectionHeading = (
  ...
  borderColor: 'divider',
  bgcolor: 'grey.200',
  ...(first ? {} : { borderTop: 1, borderTopColor: 'divider' }),
});
